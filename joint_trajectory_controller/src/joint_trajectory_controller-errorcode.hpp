...
#ifndef OROCOS_JOINT_TRAJECTORY_CONTROLLER_ERRORCODE_HPP
#define OROCOS_JOINT_TRAJECTORY_CONTROLLER_ERRORCODE_HPP
...
#endif //OROCOS_JOINT_TRAJECTORY_CONTROLLER_ERRORCODE_HPP
