	...
	case $opt in
		1) check_kuka_ip
				...
				then				
					...
					gnome-terminal --geometry 128x20+0+0 -e "bash -i -c 'deployer-corba-xenomai -s "KUKALauncher.ops" -l Warning; bash'" %F &>/dev/null &)  
					corekuka=true
				else
		...
		2) check_arch_ip
				...
				then				
					...
					(cd ${HOME}/neuebot_ws/src/Launchers
					gnome-terminal --geometry 128x20+0+0 -e "bash -i -c 'deployer-corba-xenomai -s "ArchLauncher.ops" -l Warning; bash'" %F &>/dev/null &)  
					corekuka=true
				else
		...
		3) check_vrep 
				...
				then
					...
					(cd ${HOME}/neuebot_ws/src/Launchers
					 gnome-terminal --geometry 128x20+0+0 -e "bash -i -c 'deployer-corba-xenomai -s "ArchSimLauncher.ops" -l Warning; bash'" %F &>/dev/null &)
					corevrep=true
				else 
		...
		4) check_core_deployer
				...
				then
					...
					(cd ${HOME}/neuebot_ws/src/Launchers
					 gnome-terminal --geometry 128x20+0+395 -e "bash -i -c 'deployer-corba-xenomai -s "ApplicationLauncher.ops" -l Warning; bash'" %F &>/dev/null &)  
					app=true
				else 
		...
		6) check_kuka_ip
				...
				then				
					...
					gnome-terminal -e "bash -i -c 'deployer-corba-xenomai -s "KUKALauncherRobot.ops" -l Warning; bash'" %F &>/dev/null &)  
					haptickuka=true
				else
		...
		7) check_vrep 
				...
				then
					...
					(cd ${HOME}/HapticWorkspace/src/Launchers
					 gnome-terminal -e "bash -i -c 'deployer-corba-xenomai -s "KUKALauncherTest.ops" -l Warning; bash'" %F &>/dev/null &)  
					hapticvrep=true
				else 
